...
@app.route("/agenda-sacerdotes")
def agenda_sacerdotes():
    """
    Página pública (sin iniciar sesión) para que los sacerdotes de la
    parroquia consulten qué misas especiales hay programadas y se
    organicen entre ellos. Solo lectura -- no se puede editar nada
    desde aquí.
    """
    proximas = db.listar_reservaciones_futuras()
    return render_template(
        "agenda_sacerdotes.html", proximas=proximas, etiquetas=db.ETIQUETAS_TIPO_RESERVACION,
    )
